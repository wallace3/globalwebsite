    ...
    <div>
        ...
        <div class="py-16 overflow-hidden relative" data-aos="fade-up">
            <swiper
                ...
                <swiper-slide v-for="(item, index) in portfolioOne" :key="index" class="portfolio-card relative before:absolute before:top-0 before:left-0 before:w-full before:h-full before:opacity-100 before:duration-300 group overflow-hidden block">
