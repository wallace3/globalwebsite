        ...
        <div class="flex">
            ...
            <div class="w-full md:w-1/2 lg:max-w-lg xl:max-w-3xl lg:w-full py-16 px-[20px] sm:px-8 lg:p-16 xl:p-24 relative z-10 flex items-center overflow-hidden">
                <div class="mx-auto md:mx-0 max-w-md">
                    ...
                    <p class="text-lg mt-[15px]" data-aos="fade-up" data-aos-delay="100">Inicia de sesión y obten la posibilidad de adquirir piezas únicas</p>
                    <div class="mt-7" data-aos="fade-up" data-aos-delay="200">
                        <label class="text-base sm:text-lg font-medium leading-none mb-2.5 block dark:text-white">Correo eletrónico</label>
