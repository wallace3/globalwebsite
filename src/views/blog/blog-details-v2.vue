                ...
                <div class="max-w-[940px] mx-auto" data-aos="fade-up">
                    <div>
                        <ul class="flex items-center gap-[10px] flex-wrap">
                            <li class="text-[15px] leading-none dark:text-white">{{data && data.date ? data.date : '13th March, 2025'}}</li>
                            <li><router-link to="/blog-tag" class="inline-block text-title font-medium text-[15px] leading-none py-[10px] px-5 rounded-md bg-primary-midum">{{data && data.tag ? data.tag : 'Interior'}}</router-link></li>
                        </ul>
                        <h1 class="text-2xl leading-snug sm:text-3xl sm:leading-snug md:text-[40px] mt-4 md:mt-6 md:leading-snug">{{data && data.title ? data.title : 'How to Choose the Perfect Sofa for Living Room'}} </h1>
                    ...
                    <div class="s-py-50 flex justify-between flex-col md:flex-row gap-8 md:gap-6" data-aos="fade-up">
                        <div v-for="(item, index) in recentPost" :key="index" class="md:max-w-[390px] w-full">
                            ...
                            <div class="group flex sm:items-center gap-[15px]">
                                <router-link to="/blog-details-v1" class="max-w-[80px] h-auto sm:max-w-[114px] w-full flex-none block">
