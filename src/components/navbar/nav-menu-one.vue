...
<template>
    <div class="flex items-center gap-4 sm:gap-6">
        ...
        <button class="relative hdr_cart_btn" @click="cartList = !cartList">
            <span class="absolute w-[22px] h-[22px] bg-secondary top-[0px] -right-[11px] rounded-full flex items-center justify-center text-xs leading-none text-white">22</span>
